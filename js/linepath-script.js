...
*/
  ...
  for (var i = 0; i < jsonObject['canvas'].length; i++) {
    if(document.getElementById(jsonObject['canvas'][i]["element"])){
      ...
      canvas_list.push([this_canvas, jsonObject['canvas'][i]["linecolor"], jsonObject['canvas'][i]["paths"], 0]);
    }
  }
  }

  /* CREATE A CANVAS WITH CORRECT SETTINGS */
  function create_new_canvas(width = 400, height = 200, backcolor = "black", element=null){
    ...
    document.getElementById(element).appendChild(this_canvas);
